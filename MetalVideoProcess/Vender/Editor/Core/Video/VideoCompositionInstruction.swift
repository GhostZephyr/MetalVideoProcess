...
open class VideoCompositionInstruction: NSObject, AVVideoCompositionInstructionProtocol {
    ...
    open var _timeRange: CMTimeRange = CMTimeRange()
    open var timeRange: CMTimeRange {
        get {
            return _timeRange
        }
    }
    open var _enablePostProcessing: Bool = false
    open var _containsTweening: Bool = false
    
    open var enablePostProcessing: Bool {
        get {
            return _enablePostProcessing
        }
    }
    
    open var containsTweening: Bool {
        get {
    ...
    open var passingThroughVideoCompositionProvider: VideoCompositionProvider?
    
    open var backgroundColor: CIColor = CIColor(red: 0, green: 0, blue: 0)
    ...
    public init(thePassthroughTrackID: CMPersistentTrackID, forTimeRange theTimeRange: CMTimeRange) {
        ...
        _requiredSourceTrackIDs = [NSValue]()
